...
- 👨‍💻 Check out my featured engineering projects and digital designs at [adeeksha.info](https://adeeksha.info)
- 📫 Reach me through my website or connect with me on LinkedIn to talk tech, design, or architecture
- ⚡ Fun fact: I handle the entire digital lifecycle — from 3D brand concepts and UI, to architecting the PostgreSQL backend, to deploying the final server

### 🛠️ Core Stack
**Languages:** Java, C++, PHP, CSS3
**Frontend:** React, Vue.js, TailwindCSS
**Backend & Databases:** Node.js, PostgreSQL, MongoDB, Prisma
...
![](https://github-readme-stats.shion.dev/api?username=Nethapul&theme=dark&hide_border=false&include_all_commits=false&count_private=false)
